...
root.resizable(0,0)
root.config(bg="PalePink")

Label(root,text="Daily To-Do List", bg="PalePink", font=("Times New Roman",14), wraplength=300).place(x=35, y=0)

tasks=Listbox(root, selectbackground="Silver", bg="Gold", font=("Helvetica",12), height=12,width=25)
scroller=scrollerbar(root,orient=VERTICAL, command=tasks.yview)
